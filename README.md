...
1. Open [WORKSHOP.md](WORKSHOP.md)
2. Pick a small app idea
3. Work through the four blocks in order
4. Let the build agent create the app directly in this repository
